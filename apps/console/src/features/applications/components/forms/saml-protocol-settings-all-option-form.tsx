...
/**
 * Proptypes for the oauth protocol settings form component.
 */
interface SAMLProtocolAllSettingsFormPropsInterface extends TestableComponentInterface {
    initialValues: any;
 ...
 *
 * @param {SAMLProtocolAllSettingsFormPropsInterface} props - Props injected to the component.
 *
 * @return {React.ReactElement}
 */
export const SAMLProtocolAllSettingsForm: FunctionComponent<SAMLProtocolAllSettingsFormPropsInterface> = (
    props: SAMLProtocolAllSettingsFormPropsInterface
): ReactElement => {
...
/**
 * Default props for the all saml protocol settings form component.
 */
SAMLProtocolAllSettingsForm.defaultProps = {
    "data-testid": "saml-protocol-settings-all-option-form"
};
